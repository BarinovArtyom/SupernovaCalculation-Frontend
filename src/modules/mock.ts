...
export const mockScopes: Scope[] = [
  {
    ...
    status: true,
    img_link: "http://127.0.0.1:9000/vedro/1.jpg",
    filter: "F775W.",
    lambda: 775,
    delta_lamb: 150,
    zero_point: 2518
  },
  {
    ...
    status: true,
    img_link: "http://127.0.0.1:9000/vedro/2.jpg",
    filter: "F775W.",
    lambda: 775,
    delta_lamb: 150,
    zero_point: 2518
  },
  {
    ...
    status: true,
    img_link: "http://127.0.0.1:9000/vedro/3.jpg",
    filter: "F775W.",
    lambda: 775,
    delta_lamb: 150,
    zero_point: 2518
  },
  {
    ...
    status: true,
    img_link: "http://127.0.0.1:9000/vedro/4.jpg",
    filter: "F775W.",
    lambda: 775,
    delta_lamb: 150,
    zero_point: 2518
